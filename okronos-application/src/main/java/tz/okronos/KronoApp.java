...
public class KronoApp extends Application {
	private OperatorSceneController operatorSceneController;
    ...
    public void start(Stage stage) throws Exception {
    	...
    	operatorSceneController = operatorBuilder.operatorSceneController();
    	ctx.setOperatorSceneController(operatorSceneController);
